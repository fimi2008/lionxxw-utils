...
import com.lionxxw.utils.FormatUtil;
...
public final class RsaCodingUtil {
	 ...
	 * @return
	 */
	public static String decryptByPriPfxFile(String src, String pfxPath, String priKeyPass) throws RuntimeException {
	 ...
	 * @return
	 */
	public static String decryptByPriPfxStream(String src, byte[] pfxBytes, String priKeyPass) throws RuntimeException {
	 ...
	 * @return
	 */
	public static String decryptByPrivateKey(String src, PrivateKey privateKey) throws RuntimeException {
		if (FormatUtil.isEmpty(src)) {
			return null;
		}
		try {
			...
			throw new RuntimeException("解密内容不是正确的UTF8格式");
		} catch (Exception e) {
			throw new RuntimeException("解密内容异常");
		}
	}
	...
	public static byte[] rsaByPublicKey(byte[] srcData, PublicKey publicKey, int mode) {
		try {
			...
			throw new RuntimeException("公钥算法-不存在的解密算法");
		} catch (NoSuchPaddingException e) {
			throw new RuntimeException("公钥算法-无效的补位算法");
		} catch (IllegalBlockSizeException e) {
			throw new RuntimeException("公钥算法-无效的块大小");
		} catch (BadPaddingException e) {
			throw new RuntimeException("公钥算法-补位算法异常");
		} catch (InvalidKeyException e) {
			throw new RuntimeException("公钥算法-无效的私钥");
		}
	}
	...
	public static byte[] rsaByPrivateKey(byte[] srcData, PrivateKey privateKey, int mode) {
		try {
			...
			throw new RuntimeException("私钥算法-不存在的解密算法");
		} catch (NoSuchPaddingException e) {
			throw new RuntimeException("私钥算法-无效的补位算法");
		} catch (IllegalBlockSizeException e) {
			throw new RuntimeException("私钥算法-无效的块大小");
		} catch (BadPaddingException e) {
			throw new RuntimeException("私钥算法-补位算法异常");
		} catch (InvalidKeyException e) {
			throw new RuntimeException("私钥算法-无效的私钥");
		}
	}
